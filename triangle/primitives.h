...
triangle_t tri1 = { 0x808080,{ {.p={0x44, 0x40}}, {.p={0x64, 0x60}}, {.p={0x24, 0x60}} } };

triangle_t pyramid[] = {
    { 0xA08000,{ {.p={0x24, 0x20}}, {.p={0x44, 0x40}}, {.p={0x04, 0x49}} } },
    { 0x008000,{ {.p={0x40, 0x60}}, {.p={0x60, 0x80}}, {.p={0x20, 0x80}} } },
    { 0x000080,{ {.p={0x60, 0x40}}, {.p={0x80, 0x60}}, {.p={0x40, 0x60}} } }
};
